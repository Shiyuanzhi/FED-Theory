...
\titleCHN{频度演化动力学的自增强壁垒模型：基于非线性动力系统的文明演化分析}
\titleENG{A Nonlinear Frequency-Barrier Model for Civilizational Evolution: Dynamical Analysis and Historical Validation}
